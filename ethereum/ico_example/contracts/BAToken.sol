...
contract BAToken is StandardToken, SafeMath {
  ...
  uint256 public constant tokenContributionMax = 20 * tokenExchangeRate;
  ...
  function createTokens() payable external {
    ...
    // check that contribution is not too high
    uint256 totalContributionWouldBe = safeAdd(balances[msg.sender], tokens);
    if (totalContributionWouldBe > tokenContributionMax) throw;
